...
//            load: function (data, onLoad, datamng, onProgress) {
//                var scope = this;
//                scope.parse(data, onLoad, datamng, onProgress);
//            },

//            parse: function (data, onload, datamng, onProgress) {
...
//                    // MeshData
//                    function ReadDataBlock(ti) {
//                        var m_StreamCurrentPosition = ti.position;

//                        var view = new DataView(result, m_StreamCurrentPosition, ti.datasize);
...
//                            }
//                            bodyName = String.fromCharCode.apply(null, bodyNameBuffer);
//                            m_vecPropHeaderDic[l].name = bodyName;
//                            NameTocTableItem.name = bodyName;
                ...
                function parseData_v301(result) {
                                    ...
                                    if (tocStructure === undefined) {
                                        ...
                                        setTimeout(function () {
                                            ...
                                            if (tocPropertyIndices === undefined) {
                                                ...
                                                setTimeout(function () {
                                                    if (viewPropertyIndices !== undefined)
                    ...
                    function ImportMeshBlock(view, tiStruct) {
                        ...
                        for (var i = 0; i < MeshBlockSize; i++) {
                            ...
                            //for (var k = 0; k < colors.length; k = k + 3) {
                            //    colors[k] = color.R;
                            //    colors[k + 1] = color.G;
                            //    colors[k + 2] = color.B;
                            //    //colors[k + 3] = color.A;
