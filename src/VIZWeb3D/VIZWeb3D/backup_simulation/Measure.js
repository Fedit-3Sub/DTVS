VIZWeb3D.Measure = function (VIEW, camera, renderer) {
    ...
    function add_Coordinate(vectorA) {
        ...
        var msgX = vectorA.x.toFixed(view.Configuration.Measure.PositionalNumber);
        var msgY = vectorA.y.toFixed(view.Configuration.Measure.PositionalNumber);
        var msgZ = vectorA.z.toFixed(view.Configuration.Measure.PositionalNumber);
        measure.text = "X = " + msgX + "\r\n" + "Y = " + msgY + "\r\n" + "Z = " + msgZ;
